...
```
+-----------------------------+------------------+------------------+
|                         Time|root.weather.d2.s1|root.weather.d2.s2|
+-----------------------------+------------------+------------------+
|2013-01-01T00:00:00.000+08:00|              10.0|              15.0|
|2013-02-01T00:00:00.000+08:00|              15.0|              20.0|
|2013-03-01T00:00:00.000+08:00|               5.0|               0.0|
|2013-04-01T00:00:00.000+08:00|               0.0|               5.0|
|2013-05-01T00:00:00.000+08:00|              20.0|              10.0|
+-----------------------------+------------------+------------------+
```
...
```sql
select EuclidDis(d2.s1,d2.s2) from root.weather
```
...
```
+-----------------------------+------------------------------------------------+
|                         Time|EuclidDis(root.weather.d2.s1,root.weather.d2.s2)|
+-----------------------------+------------------------------------------------+
|1970-01-01T00:00:00.000+00:00|                                           14.14|
+-----------------------------+------------------------------------------------+
```
...
```
+-----------------------------+--------------------------+
|                         Time|root.weather.d1.s1        |
+-----------------------------+--------------------------+
|2013-01-01T00:00:00.000+08:00|                         4|
|2013-02-01T00:00:00.000+08:00|                         6|
|2013-03-01T00:00:00.000+08:00|                         1|
|2013-04-01T00:00:00.000+08:00|                         5|
|2013-05-01T00:00:00.000+08:00|                         3|
+-----------------------------+--------------------------+
```
...
```sql
select CUSUM(s1) from root.weather.d1
```
...
```
+-----------------------------+-------------------------+
|                         Time|CUSUM(root.weather.d1.s1)|
+-----------------------------+-------------------------+
|2013-01-01T00:00:00.000+08:00|                      4.0|
|2013-02-01T00:00:00.000+08:00|                     10.0|
|2013-03-01T00:00:00.000+08:00|                     11.0|
|2013-04-01T00:00:00.000+08:00|                     16.0|
|2013-05-01T00:00:00.000+08:00|                     19.0|
+-----------------------------+-------------------------+
```
...
|                         Time|root.weather.d1.s1        |
+-----------------------------+--------------------------+
|2013-01-01T00:00:00.000+08:00|                       100|
|2013-02-01T00:00:00.000+08:00|                       105|
|2013-03-01T00:00:00.000+08:00|                        95|
|2013-04-01T00:00:00.000+08:00|                        90|
|2013-05-01T00:00:00.000+08:00|                       110|
+-----------------------------+--------------------------+
```
...
```sql
select RANK(s1) from root.weather.d1
```
...
```
+-----------------------------+-------------------------+
|                         Time|RANK(root.weather.d1.s1) |
+-----------------------------+-------------------------+
|2013-01-01T00:00:00.000+08:00|                        3|
|2013-02-01T00:00:00.000+08:00|                        2|
|2013-03-01T00:00:00.000+08:00|                        4|
|2013-04-01T00:00:00.000+08:00|                        5|
|2013-05-01T00:00:00.000+08:00|                        1|
+-----------------------------+-------------------------+
```